...
* Configurar permisos de list, get, put en bucket
* Revisar acceso a internet (por API). Que no este en VPC o configurar NatGateway
* Configurar permiso para invocar otras lambdas
"""
